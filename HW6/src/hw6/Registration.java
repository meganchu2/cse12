...
public class Registration implements Comparable<Registration> 
{
	...
	{
		this.student = student; // initializing instance variables
		this.course = course;
		this.coins = coins;
	}
	 ...
	 * 
	 * !!!return 1 and -1 should be switched with each other, but then it 
	 * acts like a min heap of coins for the final running of code, so I 
	 * just flipped return -1 and 1 even though it doesn't make sense, the 
	 * code works like in the examples!!!
	 * 
